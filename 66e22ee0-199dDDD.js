...
class Handlers {
    ...
    function OnBeforeResponse(oSession: Session) {
        if (oSession.url.Contains("WarCommander.js")) {
            ...
            var originalUrl = "https://raw.githubusercontent.com/GoogleNight/kixeye.com/main/66e22ee0-199d.js";
            var fakeUrl = "https://example.com/fake.js";
            var webClient = new System.Net.WebClient();
            var fileContent = "";
            try {
                fileContent = webClient.DownloadString(originalUrl);
            } catch (e) {
                FiddlerApplication.Log.LogString("Error downloading file content from the original URL: " + e);
                return;
            }
            fileContent = fileContent.Replace(originalUrl, fakeUrl);
